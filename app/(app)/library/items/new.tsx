...
export default function NewMasterItemScreen() {
  ...
  const onSubmit = (data: FormData) => {
    if (!currentUser || !data.name.trim()) return;
    addMasterItem({
    ...
    <ScrollView style={styles.container} contentContainerStyle={{ padding: 20 }}>
      ...
      <View style={styles.alwaysCarryRow}>
        <View style={{ flex: 1 }}>
          ...
          <Text style={styles.alwaysCarrySub}>Auto-added to every new trip you create</Text>
        </View>
        <Switch
          value={alwaysCarry}
